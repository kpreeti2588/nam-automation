...
//	  getAccountId(accessToken);
	  try {
		  utils.del(hostAAPI + "/members/" + Dictionary.get("member_id") + "/transfers/" + transferId,  new String[] {"Accept","Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[] {"application/json","application/json","Bearer "+ Dictionary.get("AccessToken"), Environment.get("DSN"),aapiClientId, TMPSCorrelationId });
	  ...
	  if(Dictionary.get("AccessToken").equalsIgnoreCase(""))
	   {
		...
		Object[] ab=utils.get(hostAAPI+"/members/"+Dictionary.get("member_id")+"/transfers", new String[] {"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[] {"application/json","Bearer "+ Dictionary.get("AccessToken"), Environment.get("DSN"),aapiClientId, TMPSCorrelationId });
...
//	  getAccountId(accessToken);
	...
	public JSONObject getAllEventsForMember() throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/events", new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getAllEventsForMember(String memberId) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + memberId + "/events", new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
		Dictionary.put("MemberEvent", jsonObject.toString(2));
	...
	public JSONObject getSummaryForSpecificEvent(String eventId) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/events/" + eventId + "/summary", new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getAllSectionsForAnyEvent(String eventId) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/events/" + eventId + "/sections", new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getSectionDetailsForEvent(String eventId, String sectionId) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/events/" + eventId + "/sections/" + sectionId, new String[]{"Accept", "Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "application/json", "Bearer " + Dictionary.get("AccessToken"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getTermsOfUse(String eventId) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/events/" + eventId + "/termsofuse", new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), "unitas", clientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getVenue(String id) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/venues/" + id, new String[]{"Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "Bearer " + Dictionary.get("AccessToken"), "unitas", clientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public JSONObject getAllInvites(String email, String pass) throws Exception {
		...
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/invites", new String[]{"Accept", "Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "application/json", "Bearer " + aT, Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
	...
	public List<String> getSpecificInviteTicketName(String email, String pass, String inviteId, int eventId) throws Exception {
		...
		String aT = getAccessToken(email, pass);
		Dictionary.put("AT", aT);
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/invites/" + inviteId + "/events/" + eventId, new String[]{"Accept", "Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "application/json", "Bearer " + aT, Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		JSONObject embedded = (JSONObject) jsonObject.get("_embedded");
	...
	public JSONObject getSpecificInviteDetails(String email, String pass, String inviteId) throws Exception {
		...
		String aT = getAccessToken(email, pass);
		Dictionary.put("AT", aT);
		Object[] ab = utils.get(hostAAPI + "/members/" + Dictionary.get("member_id") + "/invites/" + inviteId, new String[]{"Accept", "Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "application/json", "Bearer " + aT, Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
		InputStream is = (InputStream) ab[0];
		JSONObject jsonObject = utils.convertToJSON(new BufferedReader(new InputStreamReader(is, "UTF-8")));
		System.out.println(jsonObject.toString(2));
		Dictionary.put("AllInvites", jsonObject.toString(2));
	...
	public void acceptDeclineAllInvites(String email, String pass, String key) throws Exception {
		...
		for (int i = 0; i < invites.length(); i++) {
			...
			utils.patch(hostAAPI + "/members/" + Dictionary.get("member_id") + "/invites/" + inviteId, "{\"status\":\"" + key + "\"}", new String[]{"Accept", "Content-Type", "Authorization", "DSN", "ClientId", "TMPS-Correlation-Id"}, new String[]{"application/json", "application/json", "Bearer " + Dictionary.get("AT"), Environment.get("DSN"), aapiClientId, TMPSCorrelationId});
